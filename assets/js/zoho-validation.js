// Zoho validation helpers retained for reference when using inline embeds.
// The functions expect the Zoho form globals (zf_MandArray, zf_FieldArray, etc.)
// to be defined by the embed markup before this script executes.
